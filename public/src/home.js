function getTotalBooksCount(books) {
  // Use the length property to get the total number of books
...
function getTotalAccountsCount(accounts) {
  // Use the length property to get the total number of accounts
...
function getBooksBorrowedCount(books) {
  // Use filter to get an array of borrowed books
  const borrowedBooks = books.filter(book => book.borrows.some(borrow => !borrow.returned));

  // Return the length of the borrowedBooks array, representing the count of borrowed books
